...
## 🏗️ Arquitetura
<img width="1187" height="1388" alt="image" src="https://github.com/user-attachments/assets/1376ad02-bf18-4832-9080-72b7a464e430" />
## ⚡ Lambda Actions

### 🧩 Actions Principais

- **🚀 Deploy to AWS**  
  Responsável pela **criação e atualização das funções Lambda (Customer e Admin)**, além do **API Gateway** e da **integração com o AWS Cognito**.  
  Essa action realiza o deploy completo do ambiente **serverless** da aplicação.
